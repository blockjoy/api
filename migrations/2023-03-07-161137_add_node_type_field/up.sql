...
UPDATE nodes SET node_type = 'api'::enum_node_type WHERE (properties->'id')::INTEGER = 4;
...
UPDATE nodes SET node_type = 'execution'::enum_node_type WHERE (properties->'id')::INTEGER = 7;

...
UPDATE nodes SET properties = (jsonb_set(properties, '{id}', '4'::JSONB))  WHERE node_type = 'api'::enum_node_type;
...
UPDATE nodes SET properties = (jsonb_set(properties, '{id}', '7'::JSONB))  WHERE node_type = 'execution'::enum_node_type;
